...
map("n", "<leader>A", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, {desc = "Toggle Harpoon menu"})

map("n", "<leader>1", function() harpoon:list():select(1) end, {desc = "Select Harpoon list 1"})
map("n", "<leader>2", function() harpoon:list():select(2) end, {desc = "Select Harpoon list 2"})
map("n", "<leader>3", function() harpoon:list():select(3) end, {desc = "Select Harpoon list 3"})
map("n", "<leader>4", function() harpoon:list():select(4) end, {desc = "Select Harpoon list 4"})
map("n", "<leader>5", function() harpoon:list():select(5) end, {desc = "Select Harpoon list 5"})
end
